...
void registerShapeCreators() {
    ShapeFactory::instance().registerShape("circle", [](const std::string& name, const std::vector<double>& params) {
        if (params.size() != 3)
    ...
    ShapeFactory::instance().registerShape("rectangle", [](const std::string& name, const std::vector<double>& params) {
        if (params.size() != 4)
    ...
    ShapeFactory::instance().registerShape("triangle", [](const std::string& name, const std::vector<double>& params) {
        if (params.size() != 6)
    ...
    ShapeFactory::instance().registerShape("polygon", [](const std::string& name, const std::vector<double>& params) {
